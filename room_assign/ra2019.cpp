...
static std::string churchname = "D:/users/dzhang/QFL2019/roomassign/churchlist_20190501.csv";
static std::string brname = "D:/users/dzhang/QFL2019/roomassign/buildingAndRoom-0411_2019.csv";
static std::string filename = "D:/users/dzhang/QFL2019/reports/report1556831106054.csv";
static std::string sortedname = "D:/users/dzhang/QFL2019/reports/sorted_report.csv";
static std::string filename_new = "D:/users/dzhang/QFL2019/roomassign/report_new_assignment.csv";
static std::string filename_building_distr = "D:/users/dzhang/QFL2019/roomassign/report_church_buildings.csv";
static std::string cellgroups_name = "D:/users/dzhang/QFL2019/roomassign/cell_groups.csv";
static std::string camp_all = "D:/users/dzhang/QFL2019/roomassign/camp_all.csv";
static std::string room_with_extra_beds = "D:/users/dzhang/QFL2019/roomassign/rooms_with_xbeds.csv";
...
int parsing2019(int argc, char**argv)
{
	char *c;
	while (--argc > 0 && (*++argv)[0] == '-') {
...
/*
-r D:/users/dzhang/QFL2019/reports/report0528_2018_after_camp.csv -s D:/users/dzhang/QFL2019/roomassign/sorted_report.csv -c D:/users/dzhang/QFL2019/roomassign/churchlist_20180514_milestone.csv -b D:/users/dzhang/QFL/roomassign/buildingAndRoom-0514_2018.csv
*/
int auto_roomassign_2019(int argc, char**argv)
{
	int32_t status = 0;
	bool disable_old_assign = true;/*true if I want to reset the room assignment*/
	...
	ra.printCamp_all(camp_all.c_str(), year);
